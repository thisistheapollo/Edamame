...
def base_model(inputs):
    ...
    x= Dense(units=132, kernel_initializer=initializers.HeNormal(seed=2),  activation='relu')(inputs)

    x = Dense(units=132, kernel_initializer=initializers.HeNormal(seed=2), activation='relu')(x)
...
def final_model(inputs):
    ...
    sweetness = Dense(units=1, activation='relu', name='Sweetness')(x)

    liking = Dense(units=1, activation='relu',name='Liking')(x)
